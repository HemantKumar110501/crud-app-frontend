...
const EditEmpPage = () => {
  ...
  let { id } = useParams(); //obj return krta h jisme key value mai data hota h url k dynamic values ka jisme key hota h dynamic variable joki yaha :id tha aur dynamic value joki yaha emp.id tha
  // console.log(value);  //ab nhi kyuki ab destructure krdiye
